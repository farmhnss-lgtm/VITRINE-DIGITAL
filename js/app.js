/* Vitrine Digital PRO 4.46 — hardening e integridade do Admin; Player não alterado */
...
async function load(table){
 ...
 if(error){console.error('load '+table,error);vdToast('Falha ao atualizar '+table+'. Mantendo os últimos dados carregados.','error');return demo[table]||[]}
 return data||[]
}
